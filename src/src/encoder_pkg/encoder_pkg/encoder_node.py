...
class SimpleEncoderNode(Node):
    def __init__(self):
        ...
        self.left_encoder = Button(5, pull_up=True)  # GPIO 5
        self.right_encoder = Button(6, pull_up=True)  # GPIO 6
        ...
        self.get_logger().info(f'Left encoder: GPIO 5, Right encoder: GPIO 6')
